<?php
    session_start();
     ...
     $tipAnunt=$_SESSION["tipAnunt"];
     $judet=$_SESSION["judet"];
     $oras=$_SESSION["oras"];
     $zona=$_SESSION["zona"];
     $etaj=$_SESSION["etaj"];
     $pretDeLa=$_SESSION["pretDeLa"];
     $pretLa=$_SESSION["pretLa"];
     $suprafataDeLa=$_SESSION["suprafataDeLa"];
     $suprafataLa=$_SESSION["suprafataLa"];
     $tipSortare=$_SESSION["tipSortare"];
    ...
    $sql = "SELECT * FROM housestable WHERE  Pret>='$pretDeLa' && Pret<='$pretLa' 
&& Suprafata>='$suprafataDeLa' && Suprafata<='$suprafataLa' && `Tipul anuntului`='$tipAnunt' && Judet='$judet' && Oras='$oras'
&& Zona='$zona' && Etaj='$etaj' ORDER BY $tipSortare";
